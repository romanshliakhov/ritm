  ...
  if (containerWidth > `${breakpoint}`) {
    ...
    window.addEventListener('scroll', () => {
      if (scrollPosition() > lastScroll && !containHide() && scrollPosition() > defaultOffset) {
        (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_1__.addCustomClass)(header, "sticky");
      } else if (scrollPosition() < defaultOffset) {
        (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_1__.removeCustomClass)(header, "sticky");
      }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vendor_inputMask_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/inputMask.js */ "./source/js/vendor/inputMask.js");
/* harmony import */ var _vendor_inputMask_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vendor_inputMask_js__WEBPACK_IMPORTED_MODULE_0__);


// input Mask
let selector = document.querySelectorAll('input[type="tel"]');
let im = new (_vendor_inputMask_js__WEBPACK_IMPORTED_MODULE_0___default())('+19 (999) 999-99-99');
im.mask(selector);
...
if (partnersSlider) {
  const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](partnersSlider.querySelector('.partners-section__container'), {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.FreeMode, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Grid],
    observer: true,
    observeParents: true,
    freeMode: true,
    loop: true,
...
if (promoSlider) {
  const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](promoSlider.querySelector('.promo__container'), {
